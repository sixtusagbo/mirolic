    ...
    extend: {
      colors: {
        ...
        glass: {
          ...
          'border-dark': 'rgba(245, 158, 11, 0.3)',
        }
      },
      backgroundImage: {
      ...
      boxShadow: {
        'glass': '0 8px 32px rgba(0, 0, 0, 0.4), inset 0 1px 0 rgba(245, 158, 11, 0.1)',
        'glass-dark': '0 8px 32px rgba(0, 0, 0, 0.6), inset 0 1px 0 rgba(245, 158, 11, 0.2)',
        'glow': '0 0 20px rgba(245, 158, 11, 0.4)',
        'glow-lg': '0 0 40px rgba(245, 158, 11, 0.6)',
        'inner-glow': 'inset 0 2px 4px rgba(245, 158, 11, 0.1)',
        'web3': '0 10px 25px rgba(245, 158, 11, 0.3)',
      },
      fontFamily: {
